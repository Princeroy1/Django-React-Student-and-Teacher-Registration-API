...
const Login = () => {
  ...
  const formsubmit = async (e) => {
   e.preventDefault();
    try {
      const response = await axios.post('http://127.0.0.1:8000/get_login2/',{
 ...
 useEffect(()=>{
  ...
  <input type="text" name="Email" onChange={handleFieldChange} value={formData.Email} id="" placeholder="Teacher Email" required/>
